...
pub struct AnalyzeRequest {
    ...
    #[doc = "An optional list of token filters to use when breaking the given text. This parameter can only be set when using the tokenizer parameter."]
    #[serde(
        rename = "tokenFilters",
        default,
    ...
    #[doc = "An optional list of character filters to use when breaking the given text. This parameter can only be set when using the tokenizer parameter."]
    #[serde(
        rename = "charFilters",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
#[doc = "An Azure AI service resource provisioned with a key that is attached to a skillset."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
pub struct SearchField {
    ...
    #[doc = "The name of the vector search profile that specifies the algorithm to use when searching the vector field."]
...
pub struct SearchIndex {
    ...
    #[doc = "A customer-managed encryption key in Azure Key Vault. Keys that you create and manage can be used to encrypt or decrypt data-at-rest on your search service, such as indexes and synonym maps."]
...
pub struct ServiceCounters {
    ...
    #[doc = "Represents a resource's usage and quota."]
    #[serde(rename = "skillsetCount", default, skip_serializing_if = "Option::is_none")]
    pub skillset_count: Option<ResourceCounter>,
    #[doc = "Represents a resource's usage and quota."]
    #[serde(rename = "vectorIndexSize")]
...
impl Serialize for TextTranslationSkillLanguage {
        ...
        S: Serializer,
    {
        match self {
            ...
            Self::Ko => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 32u32, "ko"),
            Self::Lv => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 33u32, "lv"),
            Self::Lt => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 34u32, "lt"),
            Self::Mg => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 35u32, "mg"),
            Self::Ms => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 36u32, "ms"),
            Self::Mt => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 37u32, "mt"),
            Self::Nb => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 38u32, "nb"),
            Self::Fa => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 39u32, "fa"),
            Self::Pl => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 40u32, "pl"),
            Self::Pt => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 41u32, "pt"),
            Self::Otq => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 42u32, "otq"),
            Self::Ro => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 43u32, "ro"),
            Self::Ru => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 44u32, "ru"),
            Self::Sm => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 45u32, "sm"),
            Self::SrCyrl => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 46u32, "sr-Cyrl"),
            Self::SrLatn => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 47u32, "sr-Latn"),
            Self::Sk => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 48u32, "sk"),
            Self::Sl => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 49u32, "sl"),
            Self::Es => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 50u32, "es"),
            Self::Sv => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 51u32, "sv"),
            Self::Ty => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 52u32, "ty"),
            Self::Ta => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 53u32, "ta"),
            Self::Te => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 54u32, "te"),
            Self::Th => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 55u32, "th"),
            Self::To => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 56u32, "to"),
            Self::Tr => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 57u32, "tr"),
            Self::Uk => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 58u32, "uk"),
            Self::Ur => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 59u32, "ur"),
            Self::Vi => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 60u32, "vi"),
            Self::Cy => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 61u32, "cy"),
            Self::Yua => serializer.serialize_unit_variant("TextTranslationSkillLanguage", 62u32, "yua"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
